...
mf_resp = sdk.users.update_password(
...
mf_resp = sdk.things.create_bulk({"name": "<thing_name_1>"}, {
                                 "name": "<thing_name_2>"}, "<user_token>")
if mf_resp.error.status == 0:
    print(mf_resp.value)
else:
    print(mf_resp.error.message)
...
mf_resp = sdk.things.get_by_channel(
    "<channel_id>", "{query_params}", "<user_token>")
if mf_resp.error.status == 0:
    print(mf_resp.value)
else:
    print(mf_resp.error.message)
...
mf_resp = sdk.channels.get_by_thing(
    "<thing_id>", "{query_params}", "<user_token>")
if mf_resp.error.status == 0:
    print(mf_resp.value)
else:
    print(mf_resp.error.message)
...
mf_resp = sdk.things.update("<thing_id>", "<user_token>", {
                            "name": "<thing_name>"})
if mf_resp.error.status == 0:
    print(mf_resp.value)
else:
...
mf_resp = sdk.things.disconnect(
    ["<channel_id>"], ["<thing_id>"], "<user_token>")
if mf_resp.error.status == 0:
    print(mf_resp.value)
else:
    print(mf_resp.error.message)
...
mf_resp = sdk.channels.create_bulk(
    [{"name": "<channel_name_1>"}, {"name": "<channel_name_2>"}],
    "<user_token>"
)
if mf_resp.error.status == 0:
    print(mf_resp.value)
...
mf_resp = sdk.channels.update("<channel_id>", "<user_token>", {
                              "name": "<channel_name_3>"})
if mf_resp.error.status == 0:
    print(mf_resp.value)
else:
...
mf_resp = sdk.groups.assign("<group_id>", "<user_token>", {
    "members": ["<user_id>" | "<thing_id_>" | "<channel_id_>"],
    "type": ["users" | "things" | "channels"]
}
)
if mf_resp.error.status == 0:
    print(mf_resp.value)
...
'''Unassign'''
mf_resp = sdk.groups.unassign("<group_id>", "<user_token>", {
    "members": ["<user_id>" | "<thing_id_>" | "<channel_id_>"],
    "type": ["users" | "things" | "channels"]
}
)
