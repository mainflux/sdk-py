...
class Things:
    ...
    def create(self, thing, token):
        ...
        http_resp = requests.post(
            self.url + "/things", json=thing, headers={"Authorization": token})
    ...
    def get(self, thing_id, token):
        ...
        http_resp = requests.get(
            self.url + "/things/" + thing_id, headers={"Authorization": token})
    ...
    def disconnect(self, channel_ids, thing_ids, token):
        ...
        http_resp = requests.delete(self.url + "/channels/" + channel_ids +
                                    "/things/" + thing_ids,
                                    headers={"Authorization": token}
                                    )
        mf_resp = response.Response()
